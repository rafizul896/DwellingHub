...
const ErrorPage = () => {
    return (
        <div className="flex justify-center flex-col items-center min-h-screen">
            ...
            <Link to='/'><button className=" mt-3 btn bg-[#59C6D2] text-white hover:text-black hover:border-2 hover:border-[#59C6D2] hover:bg-white rounded-full px-5">Go Home</button></Link>
        </div>
    );
};
