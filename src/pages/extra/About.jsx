    ...
    return (
        <div className="flex flex-col-reverse md:flex-row gap-10 items-center">
            ...
            <div className="space-y-4 flex-1 mt-5 text-center">
                <h1 className="text-center text-2xl md:text-4xl font-semibold">How much is your property worth now?</h1>
                <p className="md:text-lg">We have built our reputation as true local area experts. We have gained more knowledge about buyer interests, our neighborhood and the market than any other brand because we live locally and work for local people.</p>
