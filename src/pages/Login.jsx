                ...
                <div className="card shrink-0 w-full max-w-sm">
                    ...
                    <div className="p-2">
                        ...
                        <div className="space-y-3 mt-5">
                            <button onClick={handleGoogleLogIn} className="btn w-full border-[#6a60e2] bg-white hover:bg-[#6a60e2] hover:text-white">
                                <IoLogoGoogle className="text-lg" />
                                Login with Google
                            </button>
                            <button onClick={handleFacebookLogin} className="btn w-full border-[#6a60e2] bg-white hover:bg-[#6a60e2] hover:text-white">
